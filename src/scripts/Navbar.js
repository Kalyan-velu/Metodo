...
function appendNavbar() {
  ...
  let navbarContent = "<div class=\"overflow-hidden relative flex w-[100%] h-20 bg-purple justify-center items-center\">" +
    "<div style=\"flex-grow: 1;\"></div>" +
    "<div aria-label=\"logo\" type=\"button\" id=\"logo\" class=\"z-10 font-mono cursor-pointer text-3xl font-bold\">" +
    "Metodo" +
    "</div>" +
    ...
    "</svg>" +
    "<div style=\"flex-grow: 1;\"></div>" +
    "<ul class=\"link flex w-[50%] font-bold z-10 text-color-a  justify-evenly items-center\">" +
    "<li><a id=\"create\">Create</a></li>" +
    "<li><a id=\"past\">Previous List</a></li>" +
    "<li><a id=\"about\">About</a></li>" +
    "<li>" +
    "<a title=\"profile\" id=\"profile\" id=\"login\">" +
